...
public class ServerDatabase extends Constants {
    ...
    public ArrayList<LiteralIngredient> getLiteralIngredients(String username, String password){
        ...
        List<NameValuePair> params = new List<NameValuePair>() {
            @Override
            public void add(int location, NameValuePair object) {
            ...
            @Override
            public boolean addAll(int location, Collection<? extends NameValuePair> collection) {
                return false;
            }
            ...
            @Override
            public NameValuePair get(int location) {
                return null;
            }
            ...
            @NonNull
            @Override
            public ListIterator<NameValuePair> listIterator(int location) {
                return null;
            }

            @Override
            public NameValuePair remove(int location) {
                return null;
            }
            ...
            @Override
            public NameValuePair set(int location, NameValuePair object) {
                return null;
            }
            ...
            @NonNull
            @Override
            public List<NameValuePair> subList(int start, int end) {
                return null;
            }
